...
export class HUDPlaceableButton extends Container {
    ...
    private onPointerDown(event: FederatedPointerEvent) {
        ...
        const onMove = (e: FederatedPointerEvent) => this.updatePreviewPosition(e.global);
    ...
    private spawnPlaceable(globalPos: { x: number; y: number }, cage: Cage) {
        ...
        console.log(`Placeable spawned: ${this.placeableConfig.id} at x=${localPos.x}, y=${localPos.y}`);
    }
}
